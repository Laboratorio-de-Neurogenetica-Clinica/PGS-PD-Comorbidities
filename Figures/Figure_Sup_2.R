...
############################### Figure sup 2 , Negative Controls: Violin plots, density plots, and decile plots
...
#Make plots
p1 <- Violin_plots("Height","T2D","PD",test ="t.test",age=0) %>% label_plot(.,"A",25)
p2 <- Violin_plots("Height","MDD","PD",test ="t.test",age=0) %>% label_plot(.,"B",25)
p3 <- Violin_plots("Height","MH","PD",test ="t.test",age=0) %>% label_plot(.,"C",25)
p4 <- Violin_plots("Height","EPI","PD",test = "t.test",age=0) %>% label_plot(.,"D",25)
p5 <- PRS_histogram("Height","T2D","PD", age=0) %>% label_plot(.,"E",25)
p6 <- PRS_histogram("Height","MDD","PD",age=0) %>% label_plot(.,"F",25)
p7 <- PRS_histogram("Height","MH","PD",age=0) %>% label_plot(.,"G",25)
p8 <- PRS_histogram("Height","EPI","PD", age=0) %>% label_plot(.,"H",25)
p9 <- decil_plot("Height","T2D","PD",age=0) %>% label_plot(.,"I",25)
p10 <- decil_plot("Height","MDD","PD",age=0) %>% label_plot(.,"J",25)
p11 <- decil_plot("Height","MH","PD",age=0) %>% label_plot(.,"K",25)
p12 <- decil_plot("Height","EPI","PD",age=0) %>% label_plot(.,"L",25)
...
ggsave(file="All_figures/FigureSup2.pdf",grid_vertical,width = 22.5,height = 30)
